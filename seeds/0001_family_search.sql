...
VALUES
  ...
  (
    ...
    'https://www.toyofg.com',
    100,
    'Promoted for usable-soon coverage after standalone collector smoke tests returned structured candidate data; continue watching saved-search match quality.',
    '2026-08-28T00:00:00.000Z',
    '2026-08-28T00:00:00.000Z'
  ),
  (
  ...
  (
    ...
    'https://www.autolandoftexas.com',
    125,
    'Promoted for usable-soon coverage after standalone collector smoke tests returned 61 listings including family-relevant models; price is often missing.',
    '2026-08-29T00:00:00.000Z',
    '2026-08-29T00:00:00.000Z'
  ),
  (
  ...
  (
    ...
    'https://www.mycrownauto.com',
    170,
    'Promoted for usable-soon coverage after standalone validation returned 29 under-$20k candidates with price, mileage, color, and detail URLs.',
    '2026-08-29T00:00:00.000Z',
    '2026-08-29T00:00:00.000Z'
  )
ON CONFLICT(id) DO UPDATE SET
