...
CROWN AUTO was added as a second paused GotGoodCars feed after its dealer-owned Carsforsale URL returned HTTP 403 but its GotGoodCars inventory page fetched cleanly. The seeded URL uses the visible under-$20k price filter and standalone validation returned 29 candidates with useful ranking fields.
